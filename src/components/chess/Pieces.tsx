import { Color, Piece } from "@/lib/chess";

type Props = {
  color: Color;
};

export function Pawn({ color }: Props) {
  return (
    <svg
...
export function Knight({ color }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
...
export function Bishop({ color }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
...
export function Rook({ color }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
...
export function Queen({ color }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
...
export function King({ color }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
...
export function ChessSprite({ piece }: { piece?: Piece }) {
  if (!piece) return <p> </p>;

  if (piece.type === "king") return <King color={piece.color} />;
  if (piece.type === "queen") return <Queen color={piece.color} />;
  if (piece.type === "knight") return <Knight color={piece.color} />;
  if (piece.type === "bishop") return <Bishop color={piece.color} />;
  if (piece.type === "rook") return <Rook color={piece.color} />;
  if (piece.type === "pawn") return <Pawn color={piece.color} />;
}

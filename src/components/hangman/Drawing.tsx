    ...
    <section className="flex w-full basis-1/2 items-center justify-center p-2">
      ...
      >
        ...
        <circle
          ...
          stroke="white"
          strokeWidth="2"
          className={`transition-all duration-300 ease-in-out ${parts[0] ? "opacity-100" : "opacity-0"}`}
        />
        <rect
          id="body"
          x="49"
          ...
          height="20"
          fill="white"
          className={`transition-opacity duration-300 ease-in-out ${parts[1] ? "opacity-100" : "opacity-0"}`}
        />
        <path
          id="right-arm"
          ...
          fill="white"
          className={`transition-opacity duration-300 ease-in-out ${parts[2] ? "opacity-100" : "opacity-0"}`}
        />
        <path
          id="left-arm"
          ...
          fill="white"
          className={`transition-opacity duration-300 ease-in-out ${parts[3] ? "opacity-100" : "opacity-0"}`}
        />
        <path
          id="right-leg"
          ...
          fill="white"
          className={`transition-opacity duration-300 ease-in-out ${parts[4] ? "opacity-100" : "opacity-0"}`}
        />
        <path
          id="left-leg"
          ...
          fill="white"
          className={`transition-opacity duration-300 ease-in-out ${parts[5] ? "opacity-100" : "opacity-0"}`}
        />
      </svg>

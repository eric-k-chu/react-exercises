...
export function Drawing() {
  ...
  function appear() {
    ...
    setParts(parts.map((n, i) => (i === index ? !n : n)));
    setIndex(index + 1);
  }
    ...
    <section className="flex w-full basis-1/2 items-center justify-center p-2">
      ...
      >
        ...
        <circle
          ...
          r="7"
          strokeWidth="2"
          className={`transition-colors duration-300 ease-in-out ${parts[0] ? "stroke-neutral-50" : "stroke-transparent"}`}
        />
        <rect
          id="body"
          x="49"
          ...
          width="2"
          height="20"
          className={`transition-colors duration-300 ease-in-out ${parts[1] ? "fill-neutral-50" : "fill-transparent"}`}
        />
        <path
          id="right-arm"
          ...
          className={`transition-colors duration-300 ease-in-out ${parts[2] ? "fill-neutral-50" : "fill-transparent"}`}
        />
        <path
          id="left-arm"
          ...
          className={`transition-colors duration-300 ease-in-out ${parts[3] ? "fill-neutral-50" : "fill-transparent"}`}
        />
        <path
          id="right-leg"
          ...
          className={`transition-colors duration-300 ease-in-out ${parts[4] ? "fill-neutral-50" : "fill-transparent"}`}
        />
        <path
          id="left-leg"
          ...
          className={`transition-colors duration-300 ease-in-out ${parts[5] ? "fill-neutral-50" : "fill-transparent"}`}
        />
      </svg>
